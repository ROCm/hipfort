...
program cgthr
  ...
  complex(c_float_complex), target :: hY(5) = (/(10.0,1.0), (20.0,2.0), (30.0,3.0), (40.0,4.0), (50.0,5.0)/)
  ...
  write(*,"(a)",advance="no") "-- Running test 'rocsparse_cgthr' (Fortran 2003 interfaces) - "
