!!!!!!!!!!!!!/
! dspmm example (double-precision sparse-matrix times dense-matrix, C = alpha*A*B + beta*C, Fortran 2003 interfaces)
...
program dspmm
  ...
  write(*,"(a)",advance="no") "-- Running test 'rocsparse_dspmm' (Fortran 2003 interfaces) - "
