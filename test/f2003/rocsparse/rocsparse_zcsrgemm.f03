!!!!!!!!!!!!!/
! zcsrgemm example (double-precision complex sparse-matrix sparse-matrix multiply, Fortran 2003 interfaces)
...
program zcsrgemm
  ...
  write(*,"(a)",advance="no") "-- Running test 'rocsparse_zcsrgemm' (Fortran 2003 interfaces) - "
