!!!!!!!!!!!!!/
! dcsrgeam example (double-precision sparse matrix addition, Fortran 2003 interfaces)
...
program dcsrgeam
  ...
  write(*,"(a)",advance="no") "-- Running test 'rocsparse_dcsrgeam' (Fortran 2003 interfaces) - "
  ...
  block
    ...
    real(c_double),  target :: h_val_C(nnz_C)
