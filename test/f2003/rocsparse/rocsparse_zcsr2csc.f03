...
program zcsr2csc
  ...
  complex(c_double_complex), target :: h_csr_val(5) = (/ (1.,1.),(2.,-1.),(3.,2.),(4.,0.),(5.,-2.) /)
  ...
  write(*,"(a)",advance="no") "-- Running test 'rocsparse_zcsr2csc' (Fortran 2003 interfaces) - "
  ...
  call hipCheck(hipMalloc(d_csc_val,     size_v * 16))
  ...
  call hipCheck(hipMemcpy(c_loc(h_csc_val(1)),     d_csc_val,     size_v * 16,  hipMemcpyDeviceToHost))
