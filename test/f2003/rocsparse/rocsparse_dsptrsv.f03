!!!!!!!!!!!!!/
! dsptrsv example (double-precision sparse triangular solve, op(A)*y = alpha*x, Fortran 2003 interfaces)
...
program dsptrsv
  ...
  write(*,"(a)",advance="no") "-- Running test 'rocsparse_dsptrsv' (Fortran 2003 interfaces) - "
