...
program scsr2csc
  ...
  real(c_float), target :: h_csc_val(5)
  ...
  write(*,"(a)",advance="no") "-- Running test 'rocsparse_scsr2csc' (Fortran 2003 interfaces) - "
  ...
  call hipCheck(hipMalloc(d_csc_val,     size_v * 4))
  ...
  call hipCheck(hipMemcpy(c_loc(h_csc_val(1)),     d_csc_val,     size_v * 4,  hipMemcpyDeviceToHost))
