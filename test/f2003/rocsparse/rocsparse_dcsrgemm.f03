!!!!!!!!!!!!!/
! dcsrgemm example (double-precision sparse-matrix sparse-matrix multiply, C = alpha*A*B, Fortran 2003 interfaces)
...
program dcsrgemm
  ...
  write(*,"(a)",advance="no") "-- Running test 'rocsparse_dcsrgemm' (Fortran 2003 interfaces) - "
