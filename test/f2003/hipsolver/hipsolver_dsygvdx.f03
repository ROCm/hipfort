!!!!!!!!!!!!!!
! dsygvdx example (partial generalized symmetric-definite eigensolver, Fortran 2003)
...
program hipsolver_dsygvdx
  ...
  write(*,"(a)",advance="no") "-- Running test 'hipsolver_dsygvdx' (Fortran 2003 interfaces) - "
  ...
  call hipsolverCheck(hipsolverDsygvdx(handle, HIPSOLVER_EIG_TYPE_1, HIPSOLVER_EIG_MODE_VECTOR, &
       ...
       0.0d0, 0.0d0, 1, N, hNev, dW, dWork, lwork, dInfo(1)))
