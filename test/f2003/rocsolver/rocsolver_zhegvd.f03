!!!!!!!!!!!!!/
! zhegvd example (complex generalized Hermitian-definite eigensolver, Fortran 2003 interfaces)
...
program zhegvd
  ...
  !
  write(*,"(a)",advance="no") "-- Running test 'rocsolver_zhegvd' (Fortran 2003 interfaces) - "
