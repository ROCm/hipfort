!!!!!!!!!!!!!/
! ssyevj example (single-precision symmetric Jacobi eigensolver, Fortran 2003 interfaces)
...
program ssyevj
  ...
  !
  write(*,"(a)",advance="no") "-- Running test 'rocsolver_ssyevj' (Fortran 2003 interfaces) - "
