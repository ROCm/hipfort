!!!!!!!!!!!!!/
! spotrf example (single-precision Cholesky factorization, Fortran 2003 interfaces)
...
program spotrf
  ...
  !
  write(*,"(a)",advance="no") "-- Running test 'rocsolver_spotrf' (Fortran 2003 interfaces) - "
