!!!!!!!!!!!!!/
! dgesvdj example (double-precision Jacobi SVD, Fortran 2003 interfaces)
...
program dgesvdj
  ...
  real(c_double), target :: hV(3,3)   ! right singular vectors
  ...
  !
  write(*,"(a)",advance="no") "-- Running test 'rocsolver_dgesvdj' (Fortran 2003 interfaces) - "
