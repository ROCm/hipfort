...
program zsptrsm
  ...
  write(*,"(a)",advance="no") "-- Running test 'hipsparse_zsptrsm' (Fortran 2003 interfaces) - "
  ...
  call hipCheck(hipMemcpy(c_loc(h_C(1,1)), d_C, size_mat * 16, hipMemcpyDeviceToHost))
