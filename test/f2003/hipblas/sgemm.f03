program hip_sgemm
  ...
  real(c_float), allocatable, dimension(:) :: hc_exact
  ...
  write(*,"(a)",advance="no") "-- Running test 'SGEMM' (Fortran 2003 interfaces) - "
  ...
  call hipblasCheck(hipblasSgemm(handle,transa,transb,m,n,k,alpha,da,lda,db,ldb,beta,dc,ldc))
