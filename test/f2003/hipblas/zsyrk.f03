program hip_zsyrk
  ...
  complex(c_double_complex), target :: hA(ld,ld) = reshape([(1.0, 0.0), (2.0, 0.0), (0.0, 0.0), (3.0, 0.0)], [ld,ld])
  complex(c_double_complex), target :: hC(ld,ld)
  complex(c_double_complex) :: expected(ld,ld) = reshape([(1.0, 0.0), (0.0, 0.0), (2.0, 0.0), (13.0, 0.0)], [ld,ld])
  ...
  write(*,"(a)",advance="no") "-- Running test 'zsyrk' (Fortran 2003 interfaces) - "
  ...
  call hipblasCheck(hipblasZsyrk(handle, HIPBLAS_FILL_MODE_UPPER, HIPBLAS_OP_N, ld, ld, &
