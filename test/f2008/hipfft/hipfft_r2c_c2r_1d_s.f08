program hipfft_r2c_c2r_1d_s
  ...
  complex(4), allocatable, target, dimension(:) :: hc
  real(4), pointer, dimension(:) :: dr => null()
  complex(4), pointer, dimension(:) :: dc => null()
  ...
  write(*,"(a)",advance="no") "-- Running test 'hipFFT R2C/C2R 1D single (s)' (Fortran 2008 interfaces) - "
