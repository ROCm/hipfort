!!!!!!!!!!!!!!
! dpotf2_64 example (unblocked Cholesky with the 64-bit integer API)
...
program dpotf2_64
  ...
  write(*,"(a)",advance="no") "-- Running test 'rocsolver_dpotf2_64' (Fortran 2008 interfaces) - "
  ...
  call hipCheck(rocsolver_dpotf2_64(handle, rocblas_fill_upper, N, dA, lda, dInfo))
