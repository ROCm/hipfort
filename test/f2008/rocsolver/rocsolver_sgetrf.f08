!!!!!!!!!!!!!/
! sgetrf example (single-precision LU factorization)
...
program sgetrf
  ...
  real(c_float) :: hResult(3,3) = reshape((/&
   ...
   -51.0000000000000000, 192.500000000000000,      0.363636314868927002E-01,&
     4.00000000000000000, -70.0000000000000000,   -37.1212120056152344/), shape(hResult))
  ...
  !
  write(*,"(a)",advance="no") "-- Running test 'rocsolver_sgetrf' (Fortran 2008 interfaces) - "
