!!!!!!!!!!!!!!
! dgetrf_npvt example (double-precision LU without pivoting)
...
program dgetrf_npvt
  ...
  write(*,"(a)",advance="no") "-- Running test 'rocsolver_dgetrf_npvt' (Fortran 2008 interfaces) - "
