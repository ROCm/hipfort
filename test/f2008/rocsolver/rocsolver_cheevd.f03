!!!!!!!!!!!!!/
! cheevd example (single-precision Hermitian eigensolver)
...
program cheevd
  ...
  real(c_float) :: hD(3)                  ! eigenvalues (real)
  real(c_float) :: hE(3)                  ! workspace (real)
  ...
  !
  write(*,"(a)",advance="no") "-- Running test 'rocsolver_cheevd' (Fortran 2008 interfaces) - "
