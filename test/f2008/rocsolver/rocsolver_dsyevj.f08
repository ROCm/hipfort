!!!!!!!!!!!!!/
! dsyevj example (double-precision symmetric Jacobi eigensolver)
...
!
! NOTE: syevj writes residual, n_sweeps and info to DEVICE memory, so those are
...
program dsyevj
  ...
  !
  write(*,"(a)",advance="no") "-- Running test 'rocsolver_dsyevj' (Fortran 2008 interfaces) - "
