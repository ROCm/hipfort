!!!!!!!!!!!!!/
! dsyevd example (double-precision symmetric eigensolver)
...
program dsyevd
  ...
  real(c_double) :: hD(3)      ! eigenvalues
  real(c_double) :: hE(3)      ! workspace
  ...
  !
  write(*,"(a)",advance="no") "-- Running test 'rocsolver_dsyevd' (Fortran 2008 interfaces) - "
