!!!!!!!!!!!!!/
! zgebrd example (double-complex bidiagonal reduction)
...
program zgebrd
  ...
  real(c_double) :: hD(3)                ! diagonal of B (real)
  real(c_double) :: hE(2)                ! superdiagonal of B (real)
  complex(c_double_complex) :: hTauq(3)  ! Householder scalars (Q)
  complex(c_double_complex) :: hTaup(3)  ! Householder scalars (P)
  ...
  complex(c_double_complex), pointer :: dTauq(:)
  complex(c_double_complex), pointer :: dTaup(:)
  ...
  !
  write(*,"(a)",advance="no") "-- Running test 'rocsolver_zgebrd' (Fortran 2008 interfaces) - "
