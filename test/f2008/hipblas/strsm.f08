program hip_strsm
  ...
  write(*,"(a)",advance="no") "-- Running test 'STRSM' (Fortran 2008 interfaces) - "
  ...
  call hipblasCheck(hipblasStrsm(handle, side, uplo, transA, diag, m, n, alpha, dA, size(dA,1), dB, size(dB,1)))
