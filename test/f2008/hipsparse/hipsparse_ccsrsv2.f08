!!!!!!!!!!!!!!
! hipsparse Ccsrsv2 example (sparse triangular solve v2, single complex)
...
program hipsparse_ccsrsv2
  ...
  complex(c_float_complex) :: hVal(6) = (/ &
    (2.0,1.0), (1.0,0.0), (2.0,1.0), (3.0,0.0), (1.0,0.0), (2.0,1.0)/)
  complex(c_float_complex) :: hF(3)
  complex(c_float_complex) :: hX(3)
  ...
  complex(c_float_complex), pointer :: dVal(:), dF(:), dX(:)
  type(c_ptr) :: dBuf
  integer(c_int) :: bufSize
  write(*,"(a)",advance="no") "-- Running test 'hipsparse_ccsrsv2' (Fortran 2008 interfaces) - "
