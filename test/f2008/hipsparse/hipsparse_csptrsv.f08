...
program csptrsv
  ...
  write(*,"(a)",advance="no") "-- Running test 'hipsparse_csptrsv' (Fortran 2008 interfaces) - "
  ...
  call hipsparseCheck(hipsparseCreateDnVec(vecX, int(M,c_int64_t), c_loc(d_x(1)), HIP_C_32F))
  call hipsparseCheck(hipsparseCreateDnVec(vecY, int(M,c_int64_t), c_loc(d_y(1)), HIP_C_32F))
