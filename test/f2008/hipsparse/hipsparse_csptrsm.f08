...
program csptrsm
  ...
  complex(c_float_complex) :: h_csr_val(6) = &
  ...
  write(*,"(a)",advance="no") "-- Running test 'hipsparse_csptrsm' (Fortran 2008 interfaces) - "
  ...
  call hipsparseCheck(hipsparseSpSM_bufferSize(handle, HIPSPARSE_OPERATION_NON_TRANSPOSE, HIPSPARSE_OPERATION_NON_TRANSPOSE, &
                          c_loc(alpha), matL, matB, matC, HIP_C_32F, HIPSPARSE_SPSM_ALG_DEFAULT, spsmDescr, buffer_size))
  ...
  call hipsparseCheck(hipsparseSpSM_analysis(handle, HIPSPARSE_OPERATION_NON_TRANSPOSE, HIPSPARSE_OPERATION_NON_TRANSPOSE, &
                          c_loc(alpha), matL, matB, matC, HIP_C_32F, HIPSPARSE_SPSM_ALG_DEFAULT, spsmDescr, d_buffer))
