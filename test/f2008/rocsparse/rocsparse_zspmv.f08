!!!!!!!!!!!!!/
! zspmv example (double-precision complex sparse-matrix dense-vector multiply)
...
program zspmv
  ...
  complex(c_double_complex) :: h_csr_val(5) = (/ (1.,1.),(2.,-1.),(3.,0.),(4.,2.),(5.,-1.) /)

  complex(c_double_complex) :: h_x(3) = (/ (1.,0.),(2.,1.),(3.,-1.) /)
  ...
  write(*,"(a)",advance="no") "-- Running test 'rocsparse_zspmv' (Fortran 2008 interfaces) - "
  ...
  call rocsparseCheck(rocsparse_create_dnvec_descr(vecX, int(N,c_int64_t), c_loc(d_x), rocsparse_datatype_f64_c))
