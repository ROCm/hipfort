!!!!!!!!!!!!!/
! zcsrgeam example (double-precision complex sparse matrix addition, C = alpha*A + beta*B)
...
program zcsrgeam
  ...
  complex(c_double_complex) :: h_val_A(5) = (/ (1.,1.),(2.,-1.),(3.,0.),(4.,2.),(5.,-1.) /)

  integer(c_int) :: h_row_ptr_B(4) = (/0, 1, 2, 3/)
  integer(c_int) :: h_col_ind_B(3) = (/0, 1, 2/)
  complex(c_double_complex) :: h_val_B(3) = (/ (10.,1.),(20.,-2.),(30.,3.) /)
  ...
  complex(c_double_complex), pointer :: d_val_A(:)
  integer(c_int), pointer :: d_row_ptr_B(:), d_col_ind_B(:)
  complex(c_double_complex), pointer :: d_val_B(:)
  ...
  write(*,"(a)",advance="no") "-- Running test 'rocsparse_zcsrgeam' (Fortran 2008 interfaces) - "
