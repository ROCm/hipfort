!!!!!!!!!!!!!/
! ccsr2csc example (single-precision complex CSR -> CSC conversion / sparse transpose)
...
program ccsr2csc
  ...
  complex(c_float_complex) :: h_csr_val(5) = (/ (1.,1.),(2.,-1.),(3.,2.),(4.,0.),(5.,-2.) /)
  ...
  write(*,"(a)",advance="no") "-- Running test 'rocsparse_ccsr2csc' (Fortran 2008 interfaces) - "
