!!!!!!!!!!!!!/
! zcsrgemm example (double-precision complex sparse-matrix sparse-matrix multiply)
...
program zcsrgemm
  ...
  write(*,"(a)",advance="no") "-- Running test 'rocsparse_zcsrgemm' (Fortran 2008 interfaces) - "
