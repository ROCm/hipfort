!!!!!!!!!!!!!/
! ccsrgemm example (single-precision complex sparse-matrix sparse-matrix multiply)
...
program ccsrgemm
  ...
  write(*,"(a)",advance="no") "-- Running test 'rocsparse_ccsrgemm' (Fortran 2008 interfaces) - "
