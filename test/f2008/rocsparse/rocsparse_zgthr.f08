...
program zgthr
  ...
  complex(c_double_complex) :: hY(5) = (/(10.0d0,1.0d0), (20.0d0,2.0d0), (30.0d0,3.0d0), (40.0d0,4.0d0), (50.0d0,5.0d0)/)
  ...
  write(*,"(a)",advance="no") "-- Running test 'rocsparse_zgthr' (Fortran 2008 interfaces) - "
