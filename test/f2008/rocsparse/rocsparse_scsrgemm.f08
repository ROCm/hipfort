!!!!!!!!!!!!!/
! scsrgemm example (single-precision sparse-matrix sparse-matrix multiply, C = alpha*A*B)
...
program scsrgemm
  ...
  write(*,"(a)",advance="no") "-- Running test 'rocsparse_scsrgemm' (Fortran 2008 interfaces) - "
