!!!!!!!!!!!!!!
! chegvd example (complex generalized Hermitian-definite eigensolver, Fortran 2008)
...
program hipsolver_chegvd
  ...
  write(*,"(a)",advance="no") "-- Running test 'hipsolver_chegvd' (Fortran 2008 interfaces) - "
