!!!!!!!!!!!!!!
! ssygvdx example (partial generalized symmetric-definite eigensolver, Fortran 2008)
...
program hipsolver_ssygvdx
  ...
  write(*,"(a)",advance="no") "-- Running test 'hipsolver_ssygvdx' (Fortran 2008 interfaces) - "
