!!!!!!!!!!!!!!
! dsyevdx example (partial symmetric eigensolver, Fortran 2008 interfaces)
...
! Workspace via hipsolverD... bufferSize; devInfo device-backed.
...
program hipsolver_dsyevdx
  ...
  write(*,"(a)",advance="no") "-- Running test 'hipsolver_dsyevdx' (Fortran 2008 interfaces) - "
