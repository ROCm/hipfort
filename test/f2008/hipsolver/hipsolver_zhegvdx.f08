!!!!!!!!!!!!!!
! zhegvdx example (complex partial generalized Hermitian-definite eigensolver, Fortran 2008)
...
program hipsolver_zhegvdx
  ...
  write(*,"(a)",advance="no") "-- Running test 'hipsolver_zhegvdx' (Fortran 2008 interfaces) - "
